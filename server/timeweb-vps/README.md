# Timeweb VPS: сайт и уведомления
...
Контейнер предназначен только для нового отдельного сервиса храма. Его нельзя устанавливать на существующие серверы, базы данных или приложения аккаунта.
